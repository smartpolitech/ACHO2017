...
#
# Just: "${PATH_TO_BINARY}/Persiana --Ice.Config=${PATH_TO_CONFIG_FILE}"
#
...
if __name__ == '__main__':
	...
	if status == 0:
		...
		adapter = ic.createObjectAdapter('Persiana')
		adapter.add(PersianaI(worker), ic.stringToIdentity('persiana'))
		adapter.activate()
