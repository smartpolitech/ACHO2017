...
#
# Just: "${PATH_TO_BINARY}/Luces --Ice.Config=${PATH_TO_CONFIG_FILE}"
#
...
if __name__ == '__main__':
	...
	if status == 0:
		...
		adapter = ic.createObjectAdapter('Luces')
		#adapter.add(Luces(worker), ic.stringToIdentity('luces'))
		#adapter.activate()
