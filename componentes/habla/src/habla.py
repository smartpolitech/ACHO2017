...
#
# Just: "${PATH_TO_BINARY}/habla --Ice.Config=${PATH_TO_CONFIG_FILE}"
#
...
if __name__ == '__main__':
	...
	adapter = ic.createObjectAdapter('Habla')
	adapter.add(HablaI(worker), ic.stringToIdentity('habla'))
	adapter.activate()
